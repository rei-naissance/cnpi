    ...
    <div className="flex flex-col min-h-screen">
        ...
        <footer className="bg-black text-white py-12 px-6 mt-10">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="space-y-4">
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <h3 className="text-3xl font-bold text-yellow-400">CNPI</h3>
                    </div>
                    <p className="text-gray-400">Shorten, share, and track your links with ease.</p>
                ...
                <div className="space-y-2">
                    <h4 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Company</h4>
                    <ul className="space-y-2">
            ...
            <div className="max-w-6xl mx-auto pt-8 mt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
                <p>© {new Date().getFullYear()} cnpi. All rights reserved.</p>
            </div>
        </footer>
    </div>
  )
